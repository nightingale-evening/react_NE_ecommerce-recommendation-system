        ...
        <section className="text-gray-400 bg-gray-900 body-font">
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">Shop Smarter, Not Harder – Alita Picks Just for You!"</h1>
                    <p className="mb-8 leading-relaxed">Imagine a personal shopper that knows exactly what you like. We analyzes your choices to deliver handpicked recommendations you’ll love. No more scrolling for hours – just smart suggestions that fit your taste and budget.</p>
                    ...
                    <div className="flex lg:flex-row md:flex-col mt-20 text-gray-300">
                ...
                <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                    <img className="object-cover object-center rounded" alt="hero" src="/images/item.jpg" />
                </div>
            </div>
        </section>
    )
